...
public class AdminController {
     ...
     * @return представление (шаблон) admin
     */
    ...
    /**
     * Отредактировать роль пользователя
     * @param user пользователь
     * @param model модель (UI)
     * @return представление (шаблон) user-edit
     */
    @GetMapping("/admin/user/edit/{user}")
    public String userEdit(@PathVariable("user") User user,
                                                 Model model,
                                                 Principal principal) {
